...
import com.huixiaoer.xxx.auth.config.interceptor.CurrentUserHandler;
import com.huixiaoer.xxx.auth.config.interceptor.LoginAuthInterceptor;
...
public class MvcConfig extends WebMvcConfigurerAdapter {
	...
	public void addArgumentResolvers(List<HandlerMethodArgumentResolver> argumentResolvers) {
		...
		argumentResolvers.add(new CurrentUserHandler());
	}
