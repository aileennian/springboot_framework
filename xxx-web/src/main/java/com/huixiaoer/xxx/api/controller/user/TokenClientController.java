package com.huixiaoer.xxx.api.controller.user;
...
import com.huixiaoer.xxx.api.controller.BaseController;
...
public class TokenClientController extends BaseController {
	...
	public ResponseEntity<String> login(
		...
		if (vo.isSuccess()){
			...
			return new ResponseEntity<String>(vo.toString(),HttpStatus.OK);
		}		
	}
	...
	public String logout(ModelMap model, HttpServletRequest request,HttpServletResponse response)
		 ...
		 * 返回值处理
		 */
		ApiResultVo<String> apiVo = new ApiResultVo();
		if (vo.isSuccess()){
			apiVo.setOk("");
		}else{
			apiVo.setErrcode(1);
		...
		model.put("apiResultVo", apiVo.toString());
		return "api";
	}
	...
	public String getToken(@CurrentUser UserInfo user, ModelMap model, HttpServletRequest request,HttpServletResponse response)
			throws ServletException, IOException {
