package com.nian.xxx.web.controller.user;
...
import com.nian.api.ApiParameter;
import com.nian.api.ApiResultVo;
...
import com.nian.xxx.web.controller.BaseController;
...
public class TokenClientController extends BaseController {
	...
	public ResponseEntity<ApiResultVo<UserMode>> login(
		...
		if (vo.isSuccess()){
			...
			apiVo.setError(HttpStatus.UNAUTHORIZED.value(),vo.getMessage()!=null?vo.getMessage():"");
